...
<div >
    <div class="relative flex flex-col bg-clip-border  bg-white text-gray-700 h-screen ml-20 w-full max-w-[16rem] p-4 shadow-xl shadow-blue-gray-900/5">
        <div class="mb-2 p-4">
          <h5 class="block antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-gray-900">{{ $equipe->name }}</h5>
        </div>
        <nav class="flex flex-col gap-1 min-w-[240px] p-2 font-sans text-base font-normal text-gray-700">
          <x-equipe-link  :href="route('equipe', ['id' => request()->route('id')])"  :active="request()->routeIs('equipe')" wire:navigate>
          Página Inicial
            </x-equipe-link>
            ...
            <x-equipe-link :href="route('equipe.tarefas', ['id' => request()->route('id')])" :active="request()->routeIs('equipe.tarefas')" wire:navigate>
               Tarefas
                  </x-equipe-link>
