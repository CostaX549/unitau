...
new class extends Component {
  ...
  <div class="flex flex-col items-center justify-center w-screen min-h-screen bg-gray-100 text-gray-800 p-10 ">
    ...
    <!-- Component Start -->
    <div class="flex flex-col flex-grow w-full w-100 bg-white shadow-xl rounded-lg overflow-hidden ">
      ...
      <div class="bg-gray-300 p-4 mt-auto"> <!-- Use mt-auto to push the input to the bottom -->
